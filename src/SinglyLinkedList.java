...
class RemoveDuplicatesChallenge {
    public static <T> void removeDuplicates(SinglyLinkedList<T> list) {
        ...
        SinglyLinkedList<T>.Node next=curr.nextNode;
        while(curr!=null){
            if(!set.isEmpty() && set.contains(curr.data)){
                prev.nextNode=next;
                curr=next;
                if(next!=null)
                    next=curr.nextNode;
...
//        list.insertAfter(55,1000);
//        list.insertAfter(4,55);
//        list.insertAfter(2321,4);
//        list.insertAfter(55,2321);
